...
- **Python 3.9 compat:** Local Mac runs 3.9. Use `Optional[X]`, `Dict[str, X]`, `Union[A, B]` — never `X | None` or `dict[str, X]` in type annotations. Even with `from __future__ import annotations`, Pydantic evaluates these at runtime.
